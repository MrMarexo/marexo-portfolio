...
export const Hero = () => (
  <section className="mt-40 flex h-[700px] flex-col items-center">
    <h1 className="px-4 text-center text-5xl font-[600] sm:w-[60%] lg:text-7xl xl:text-8xl">
    ...
    <Button variant="fill">Download app</Button>
  </section>
);
